...
' This repository is a debugging reference only; never modify MPP files from it.
WScript.Echo "Execution blocked: this repository is a debugging reference only."
WScript.Echo "Obtain the working scripts and migration tools from the approved Altus Partner Portal:"
WScript.Echo "https://partners.altus.pro/rooms/vdv9eco7129j5vxz5ta6z6p3?stage=wkxxnaeua9j1psh32tmafijh"
WScript.Quit 1
